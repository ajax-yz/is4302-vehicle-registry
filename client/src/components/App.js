...
const App = () => {
  ...
  const getRole = async() => {
    ...
    const roleBytes = await drizzle.contracts.VehicleRegistry.methods.roleOfAddress(account).call();
  ...
  return (
    <HashRouter>
      <Switch>
        ...
        <PublicRoute path="/login" component={Login} role={userRole} isLoggedIn={isLoggedInOnMetaMask} />
